...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Ideator Events",
    description: [
      "Developed a promotional website and built a complete Event ERP system using the MERN stack.",
      "Implemented frontend UI, backend APIs, database architecture, and admin dashboards to manage event operations efficiently.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.NODEJS,
  ...
  },
  {
    ...
    company: "SBCEST",
    description: [
      "Collaborated in a team to develop a fully functional e-commerce web application.",
      "Worked on product listings, authentication, cart functionality, and responsive UI implementation.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.NODEJS,
  ...
  },
  {
    ...
    company: "IIT Bombay x Jain University",
    description: [
      "Built the official website for the event 'Typoday 2026'.",
      "Designed and developed event pages, registration interfaces, and responsive layouts for public engagement.",
    ],
    skills: [
      SkillNames.HTML,
      SkillNames.CSS,
